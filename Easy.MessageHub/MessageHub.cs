namespace Easy.MessageHub
{
    ...
    /// <summary> An implementation of the <c> Event Aggregator </c> pattern. </summary>
    public sealed class MessageHub : IMessageHub
    {
        ...
        /// <summary> Returns a single instance of the <see cref="MessageHub" /> </summary>
        ...
        /// <see cref="MessageHub" />. <remarks> Invoking this method with a new
        /// <paramref name="onMessage" /> overwrites the previous one. </remarks>
        /// </summary>
        /// <param name="onMessage"> 
        /// The callback to invoke on every message <remarks> The callback receives the type of the
        /// message and the message as arguments </remarks>
        /// </param>
        ...
        /// <summary> 
        /// Invoked if an error occurs when publishing a message to a subscriber. <remarks> Invoking
        /// this method with a new <paramref name="onError" /> overwrites the previous one. </remarks>
        /// </summary>
        ...
        /// <summary> Publishes the <paramref name="message" /> on the <see cref="MessageHub" />. </summary>
        ...
        /// <param name="action"> 
        /// The callback to be invoked once the message is published on the <see cref="MessageHub" />
        /// </param>
        ...
        /// <summary> Unsubscribes a subscription from the <see cref="MessageHub" />. </summary>
        ...
        /// <summary> Checks if a specific subscription is active on the <see cref="MessageHub" />. </summary>
        /// <param name="token"> The token representing the subscription </param>
        ...
        /// <summary> 
        /// Clears all the subscriptions from the <see cref="MessageHub" />. <remarks> The global
        /// handler and the global error handler are not affected </remarks>
        /// </summary>
        public void ClearSubscriptions() => _subscriptions.Clear(false);

        /// <summary> Disposes the <see cref="MessageHub" />. </summary>
        public void Dispose()
        {
            _globalHandler = null;
